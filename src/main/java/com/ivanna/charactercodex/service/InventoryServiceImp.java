...
public class InventoryServiceImp implements InventoryService {
    ...
    public InventoryServiceImp(InventoryRepository inventoryRepository, WeaponRepository weaponRepository, ArmorRepository armorRepository, InvObjectRepository invObjectRepository, InventoryEntryRepository inventoryEntryRepository, CharacterAccessGuard characterAccessGuard, CharacterMapper characterMapper) {
